 ...
 */
public class GenerateMngFormHtmlFile extends AbsGenerate {

    @Override
    public void generate(GenerateContext context) throws IOException, TemplateException {
        Template template = context.getCfg().getTemplate("src/tlp/adminMngForm.ftl");
        ...
        print(template, data, context.getMngFormHtmlPath());
    }
}
