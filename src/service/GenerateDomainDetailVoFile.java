 ...
 */
public class GenerateDomainDetailVoFile extends AbsGenerate {
    @Override
    public void generate(GenerateContext context) throws IOException, TemplateException {

        Template template = context.getCfg().getTemplate("src/tlp/domainDetailVo.ftl");
        ...
        print(template, data,context.getDomainDetailPath());
    }
}
