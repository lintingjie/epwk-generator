 ...
 */
public class GenerateMngJSFile extends AbsGenerate {

    @Override
    public void generate(GenerateContext context) throws IOException, TemplateException {
        Template template = context.getCfg().getTemplate("src/tlp/adminMngJS.ftl");
        ...
        print(template, data, context.getMngJSPath());
    }
}
